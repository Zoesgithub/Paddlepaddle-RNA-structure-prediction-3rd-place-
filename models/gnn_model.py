...
class GNNStack(supermodel):
    def __init__(self, 
        ...
        self.out_edge_matrix=nn.parameter.Parameter(data=torch.rand(100, 100))
        self.out_linear=nn.Linear(node_dim, 128)
        self.out_edge_linear=nn.Linear(128*2,1)
        self.out_node_linear=nn.Linear(128, 1)
        self.sig=nn.Sigmoid()
